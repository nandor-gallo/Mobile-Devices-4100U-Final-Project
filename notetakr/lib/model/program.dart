...
class Programs {
    ...
    factory Programs.fromJson(Map<String, dynamic> json) => Programs(
        ...
        program: List<ProgramElement>.from(json["program"].map((x) => ProgramElement.fromJson(x))),
    );
...
class ProgramElement {
    ...
    factory ProgramElement.fromJson(Map<String, dynamic> json) => ProgramElement(
        ...
        title: json["title"],
        link: json["link"],
        programType: List<ProgramType>.from(json["program_type"].map((x) => programTypeValues.map[x])),
    ...
    Map<String, dynamic> toJson() => {
        ...
        "title": title,
        "link": link,
        "program_type": List<dynamic>.from(programType.map((x) => programTypeValues.reverse[x])),
        "summary": summary,
    };
}
...
enum Faculty { FACULTY_OF_BUSINESS_AND_INFORMATION_TECHNOLOGY, FACULTY_OF_EDUCATION, FACULTY_OF_ENERGY_SYSTEMS_AND_NUCLEAR_SCIENCE, FACULTY_OF_ENGINEERING_AND_APPLIED_SCIENCE, FACULTY_OF_HEALTH_SCIENCES, FACULTY_OF_SCIENCE, FACULTY_OF_SOCIAL_SCIENCE_AND_HUMANITIES }

final facultyValues = EnumValues({
    "Faculty of Business and Information Technology": Faculty.FACULTY_OF_BUSINESS_AND_INFORMATION_TECHNOLOGY,
    "Faculty of Education": Faculty.FACULTY_OF_EDUCATION,
    "Faculty of Energy Systems and Nuclear Science": Faculty.FACULTY_OF_ENERGY_SYSTEMS_AND_NUCLEAR_SCIENCE,
    "Faculty of Engineering and Applied Science": Faculty.FACULTY_OF_ENGINEERING_AND_APPLIED_SCIENCE,
    "Faculty of Health Sciences": Faculty.FACULTY_OF_HEALTH_SCIENCES,
    "Faculty of Science": Faculty.FACULTY_OF_SCIENCE,
    "Faculty of Social Science and Humanities": Faculty.FACULTY_OF_SOCIAL_SCIENCE_AND_HUMANITIES
});

enum ProgramType { UNDERGRADUATE, GRADUATE, CO_OP_OR_INTERNSHIP, PATHWAYS_DIPLOMA_TO_DEGREE, ONLINE, PROFESSIONAL }
